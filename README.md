...
Clone the project and traverse to the project files then run the following command.

```cmd
RapidApi.exe --schema "C:\Users\UserName\source\repos\schema.xml" --app "myodataservice"
```
